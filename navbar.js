    ...
    candidate: [
      ...
      },
      {
        ...
        items: [
          ...
          { icon: 'fa-envelope-open-text', text: 'Cover Letter của tôi',          href: '#' },
          { icon: 'fa-handshake',          text: 'Nhà tuyển dụng muốn kết nối',  href: '#' },
    ...
    employer: [
      {
        ...
        items: [
          { icon: 'fa-pen-to-square', text: 'Đăng tin tuyển dụng',       href: '#' },
          { icon: 'fa-rectangle-list', text: 'Danh sách tin tuyển dụng', href: '#' },
        ]
      },
      {
      ...
      },
      {
        ...
        items: [
          { icon: 'fa-building',      text: 'Hồ sơ công ty',              href: '#' },
          { icon: 'fa-building-pen',  text: 'Chỉnh sửa thông tin công ty', href: '#' },
        ]
      },
      {
